...
const getHeroSlides = (language: string) => [
	{
		image: heroProtein,
		kicker:
			language === "fr" ? "Performance végétale" : "Plant-powered performance",
		title:
			language === "fr"
				? "Des compléments propres pour l'énergie, la force et la récupération."
				: "Clean supplements for energy, strength, and recovery.",
		copy:
			language === "fr"
				? "Créez votre stack quotidien avec des formules transparentes, un excellent goût et des ingrédients choisis pour de vraies routines."
				: "Build your daily stack with transparent formulas, great taste, and ingredients chosen for real routines.",
		cta:
			language === "fr" ? "Acheter les meilleures ventes" : "Shop best sellers",
	...
	},
	{
		...
		title:
			language === "fr"
				? "Commencez concentré sans coup de barre dû au sucre."
				: "Start focused without the sugar crash.",
		copy:
			language === "fr"
				? "Hydratation, électrolytes, adaptogènes et superaliments conçus pour alléger vos journées bien remplies."
	...
	},
	{
		...
		kicker:
			language === "fr"
				? "Une récupération qui suit le rythme"
				: "Recovery that keeps up",
		title:
			language === "fr"
				? "Dormez plus profondément, récupérez plus vite, revenez plus fort."
				: "Sleep deeper, recover faster, come back stronger.",
		copy:
			language === "fr"
				? "Favorisez le repos, la réparation musculaire et la régularité avec des essentiels propres pour l'entraînement et le bien-être quotidien."
...
const getDetailedStackSteps = (language: string) => [
	{
		...
		copy:
			language === "fr"
				? "Daily Greens et Hydra Charge aident votre matinée Ã  démarrer avec des minéraux actifs, des enzymes digestives et une concentration stable."
				: "Daily Greens and Hydra Charge help your morning start with active minerals, digestive enzymes, and steady focus.",
	...
	},
	{
		time: "02:00 PM",
		moment:
			language === "fr" ? "ENTRAÎNEMENT & CONCENTRATION" : "TRAINING & FOCUS",
		title:
			language === "fr" ? "S'entraîner avec intention" : "Train with intent",
		copy:
			language === "fr"
				? "Les mélanges de protéines et les BCAAs de performance favorisent la synthèse musculaire, l'endurance et la récupération les jours d'entraînement."
				: "Protein blends and performance BCAAs support muscle synthesis, stamina, and recovery on training days.",
	...
	},
	{
		...
		copy:
			language === "fr"
				? "Les formules de récupération Ã  libération progressive et les minéraux apaisants favorisent des cycles de sommeil plus profonds et la réparation cellulaire naturelle."
				: "Slow-release recovery formulas and soothing minerals support deeper sleep cycles and natural cellular repair.",
...
const getTrustItems = (language: string) => [
	{
		label:
			language === "fr" ? "Lots testés en laboratoire" : "Lab-tested batches",
		icon: BadgeCheckIcon,
	},
	{
		label:
			language === "fr" ? "Sans colorants artificiels" : "No artificial colors",
		icon: LeafIcon,
	},
	{
		label: language === "fr" ? "Livraison rapide" : "Fast delivery",
		icon: TruckIcon,
	},
	{
		label: language === "fr" ? "Abonnements faciles" : "Easy subscriptions",
...
const getMarqueeItems = (language: string) => [
	{
		name: language === "fr" ? "Frais & Léger" : "Fresh & Light",
		targetId: APP_ROUTES.SHOP,
	},
	{
		name: language === "fr" ? "Vitamines & Minéraux" : "Vitamins & Minerals",
		targetId: APP_ROUTES.SHOP,
	},
	{
		name: language === "fr" ? "Prébiotiques" : "Prebiotics",
		targetId: APP_ROUTES.SHOP,
	},
	{
		name: language === "fr" ? "Antioxydants" : "Antioxidants",
		targetId: APP_ROUTES.SHOP,
	},
];
...
const getProofStats = (language: string) => [
	{
		...
		label:
			language === "fr"
				? "des clients se sont sentis plus réguliers après 30 jours"
				: "customers felt more consistent after 30 days",
	},
	{
		value: "18g",
		label:
			language === "fr"
				? "de protéines par portion dans notre mélange quotidien"
				: "protein per serving in our daily blend",
	},
	{
		value: "0g",
		label:
			language === "fr"
				? "de sucre ajouté dans l'hydratation et les superaliments"
				: "added sugar in hydration and greens",
	},
	{
		value: "3rd",
		label:
			language === "fr"
				? "testé par un laboratoire tiers pour la qualité et la pureté"
				: "party tested for quality and purity",
	},
];
...
const getComparisonData = (language: string) => [
	{
		feature:
			language === "fr"
				? "Liste d'ingrédients transparente"
				: "Transparent ingredient list",
		zamazor: {
			text:
				language === "fr"
					? "Divulgation complète à 100%"
					: "100% full disclosure",
			type: "success",
		},
		typical: {
			text:
				language === "fr"
					? "Souvent caché dans des mélanges brevetés"
					: "Often hidden in proprietary blends",
			type: "fail",
		},
	},
	{
		feature:
			language === "fr" ? "Accompagnement de routine" : "Routine guidance",
		zamazor: {
			text:
				language === "fr"
					? "Stacks personnalisés par objectif"
					: "Personalized stacks by goal",
			type: "success",
		},
		typical: {
			text:
				language === "fr"
					? "Achat de produits uniquement"
					: "Product-only shopping",
			type: "fail",
		},
	},
	{
		...
		zamazor: {
			text:
				language === "fr"
					? "Sauter, suspendre ou modifier en 30s"
					: "Skip, pause, or edit in 30 seconds",
			type: "success",
		},
		typical: {
			text:
				language === "fr"
					? "Cycles rigides et difficiles à annuler"
					: "Rigid, hard-to-cancel cycles",
			type: "fail",
		},
	},
	{
		feature:
			language === "fr"
				? "Colorants & édulcorants artificiels"
				: "Artificial colors & sweeteners",
		zamazor: {
			text:
				language === "fr"
					? "Jamais utilisé (zéro artificiel)"
					: "Never used (zero artificiels)",
			type: "success",
		},
		typical: {
			text:
				language === "fr"
					? "Couramment ajoutés pour le goût/la couleur"
					: "Commonly added for flavor/color",
			type: "fail",
		},
	},
	{
		feature:
			language === "fr" ? "ContrÃƒÂ´les labo tiers" : "Third-party lab checks",
		zamazor: {
			text:
				language === "fr"
					? "Chaque lot testé + rapports publics"
					: "Every batch tested + public reports",
			type: "success",
		},
		typical: {
			text:
				language === "fr" ? "Rarely done or private" : "Rarely done or private",
			type: "fail",
		},
	},
];
...
export const HomePage = () => {
	...
	const products = useMemo(() => {
		if (!data) return [] satisfies Product[];
		return data.items;
	}, [data]);
	...
	const { data: categoryProducts, isPending: isPendingCategoryProducts } =
		useProductsByCategoryQuery(activeCategoryId);

	const routineHighlights = useMemo(() => {
		const pick = (category: string) =>
			products?.find((product) => product.category.label.includes(category));

		return [
			{
				title:
					language === "fr"
						? "Mornings that feel lighter."
						: "Mornings that feel lighter.",
				copy:
					language === "fr"
						? "Micronutriments, hydratation, and a cleaner first hour."
						: "Micronutriments, hydration, and a cleaner first hour.",
				product: pick("Greens"),
			...
			},
			{
				title:
					language === "fr"
						? "Protein with a calm finish."
						: "Protein with a calm finish.",
				copy:
					language === "fr"
						? "A simple daily protein card for strength and consistency."
						: "A simple daily protein card for strength and consistency.",
			...
			},
			{
				...
				copy:
					language === "fr"
						? "Evening support that feels soft, focused, and easy to repeat."
						: "Evening support that feels soft, focused, and easy to repeat.",
			...
			},
			{
				...
				copy:
					language === "fr"
						? "A cleaner way to stay switched on for the day ahead."
						: "A cleaner way to stay switched on for the day ahead.",
				product: pick("Energy"),
	...
	const [quizStep, setQuizStep] = useState<
		"intro" | "focus" | "diet" | "activity" | "result"
	>("intro");
	const [quizFocus, setQuizFocus] = useState<
		"performance" | "greens" | "wellness" | "energy" | "recovery" | ""
	>("");
	...
	const recommendedProduct = useMemo(() => {
		...
		return (
			products.find((p) => p.category.label.includes(targetCategory)) ||
			products[0]
		);
	}, [products, quizFocus]);
	...
	const categoryTabs = useMemo(() => {
		...
		return [
			{ id: undefined, label: language === "fr" ? "Tous" : "All" },
			...dynamicCategories,
		];
	}, [categories, language]);

	const displayedCategoryProducts = !activeCategoryId
		? products
		: categoryProducts;
	...
	return (
		<>
			<section
				className="relative w-full h-screen min-h-150 overflow-hidden border-b border-emerald-900/10 bg-emerald-950"
				style={{
			...
			>
				...
				<AnimatePresence mode="wait">
					...
					>
						...
						<div className="absolute inset-0 bg-linear-to-r from-emerald-950/90 via-emerald-950/65 to-transparent max-md:bg-emerald-950/80" />
					</motion.div>
				</AnimatePresence>
			...
			<section className="bg-[#fcfdfa] py-20 border-b border-emerald-900/10">
				<div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
					...
					<p className="mt-3 text-slate-500 text-sm sm:text-base max-w-xl mx-auto leading-relaxed">
						{language === "fr"
							? "Répondez à notre questionnaire de 30 secondes pour trouver les plantes et protéines propres adaptées à votre niveau d'activité."
					...
					{/* Quiz Box */}
					<div className="mt-12 bg-linear-to-br from-emerald-50/50 to-lime-50/20 border border-emerald-900/10 rounded-3xl p-6 sm:p-10 shadow-xs relative overflow-hidden text-left min-h-105 flex flex-col justify-between">
						{/* Step: INTRO */}
						{quizStep === "intro" && (
							<div className="flex flex-col items-center justify-center text-center py-10 my-auto w-full">
								...
								<h3 className="text-2xl font-playfair text-slate-950 font-normal">
									{language === "fr"
										? "Trouvez Votre Formule Propre Idéale"
										: "Find Your Clean Formula Match"}
								</h3>
								<p className="text-slate-500 text-sm max-w-sm mt-3 leading-relaxed">
									{language === "fr"
										? "Répondez à trois questions rapides sur votre objectif de santé, votre niveau d'activité et vos préférences alimentaires."
							...
							<div className="space-y-6 my-auto w-full">
								<div>
									...
									<h3 className="text-xl sm:text-2xl font-playfair text-slate-950 font-normal mt-1">
										{language === "fr"
											? "Quel est votre objectif principal de bien-être ou de fitness ?"
									...
									{[
										{
											...
											label:
												language === "fr"
													? "Croissance Musculaire & Force"
													: "Muscle Growth & Strength",
											icon: DumbbellIcon,
											desc:
												language === "fr"
													? "Protéines biologiques de qualité"
													: "Premium organic proteins",
										},
										{
											id: "greens",
											label:
												language === "fr"
													? "Micronutriments Quotidiens"
													: "Daily Micronutriments",
											icon: LeafIcon,
											desc:
												language === "fr"
													? "Superaliments crus actifs"
													: "Raw active superfood",
										},
										{
											id: "energy",
											label:
												language === "fr"
													? "Endurance & Concentration Naturelles"
													: "Natural Stamina & Focus",
											icon: ZapIcon,
											desc:
												language === "fr"
													? "Boost d'entraînement propre"
													: "Clean pre-workout spark",
										},
										{
											id: "recovery",
											label:
											...
											desc:
												language === "fr"
													? "BCAAs biologiques de récupération"
													: "Organic recovery BCAAs",
										},
										{
											id: "wellness",
											label:
											...
											desc:
												language === "fr"
													? "Extraits adaptogènes apaisants"
													: "Adaptogen calm extracts",
										},
									].map((opt) => (
										<button
											key={opt.id}
						...
						{quizStep === "diet" && (
							<div className="space-y-6 my-auto w-full">
								<div>
									...
									<h3 className="text-xl sm:text-2xl font-playfair text-slate-950 font-normal mt-1">
										{language === "fr"
											? "Sélectionnez votre préférence alimentaire :"
									...
									{[
										{
											...
											desc:
												language === "fr"
													? "Sans produits laitiers ni dérivés animaux"
													: "No dairy or animal derivatives",
										},
										{
											id: "organic",
											label:
												language === "fr"
													? "Biologique & Sans OGM"
													: "Organic & Non-GMO First",
											desc:
												language === "fr"
													? "Cultures crues bio certifiées les plus pures"
													: "Purest certified organic raw crops",
										},
										{
											id: "keto",
											label:
											...
											desc:
												language === "fr"
													? "Graisses et minéraux cétol sans sucre"
													: "Sugar-free keto fats & minerals",
										},
										{
											id: "glutenFree",
											label:
											...
											desc:
												language === "fr"
													? "Mélanges hypoallergéniques sûrs"
													: "Safe allergen-conscious blends",
										},
									].map((opt) => (
										<button
											key={opt.id}
										...
										>
											<p
												className={cn(
													...
													quizDiet === opt.id ? "text-white" : "text-slate-900",
												)}
											>
												{opt.label}
											</p>
									...
									{[
										{
											id: "sedentary",
											label:
												language === "fr" ? "Légèrement Actif" : "Light Active",
											desc:
												language === "fr"
													? "1-2 séances courtes/semaine"
										...
										},
										{
											...
											desc:
												language === "fr"
													? "3-4 entraînements standard/semaine"
													: "3-4 standard workouts/week",
										},
										{
											id: "intense",
											label:
											...
											desc:
												language === "fr"
													? "5+ entraînements de haute intensité/semaine"
													: "5+ high intensity workouts/week",
										},
									].map((opt) => (
										<button
											key={opt.id}
						...
						{quizStep === "result" && recommendedProduct && (
							<div className="space-y-6 w-full animate-slide-up">
								<div>
									...
									<h3 className="text-xl sm:text-2xl font-playfair text-slate-950 font-normal mt-1">
										{language === "fr"
											? "Voici votre formule propre personnalisée :"
									...
									<div className="flex-1 text-center md:text-left flex flex-col justify-between">
										<div>
											<span className="text-[10px] font-black uppercase text-emerald-800 tracking-wider bg-emerald-50 border border-emerald-900/5 px-2.5 py-0.5 rounded-full inline-block">
												{recommendedProduct.category.label}
											</span>
											...
											<p className="text-xs text-slate-500 mt-2 leading-relaxed">
												{language === "fr" ? (
													<>
														Basé sur vos objectifs pour{" "}
														<strong className="text-emerald-950 font-sans">
															{quizFocus}
														</strong>{" "}
														et votre rythme actif, cette formule premium apporte
														des nutriments propres et biodisponibles sans aucun
														produit synthétique.
													</>
												) : (
													<>
														...
														and active schedule, this premium clean formula
														delivers clean, bioavailable nourishment with zero
														synthetics.
													</>
												)}
											</p>
								...
								<div className="flex justify-end pt-2">
									...
									>
										{language === "fr"
											? "Recommencer le questionnaire Ã¢â€ Â"
											: "Retake Quiz \u2190"}
									</Button>
								</div>
							</div>
					...
					<div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-9">
						<div className="flex-1">
							...
							<h2 className="mt-2 text-3xl font-playfair font-normal tracking-tight text-slate-950 sm:text-4xl">
								{language === "fr"
									? "Formules à fort impact."
									: "High-impact formulas."}
							</h2>
							<p className="mt-3 max-w-2xl text-sm leading-relaxed text-slate-500">
								{language === "fr"
									? "Chaque produit est conçue pour s'intégrer facilement dans votre quotidien : un but clair, des ingrédients propres et des saveurs agréables."
									: "Each product is built to feel easy in real life: clear purpose, clean ingredients, and flavors that make consistency simpler."}
							</p>
						</div>
			...
			>
				<div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
					<div className="text-center mb-16">
						<p className="text-xs font-black uppercase tracking-widest text-emerald-700">
							{language === "fr" ? "Formulations" : "Formulations"}
						</p>
						...
						<p className="mt-4 mx-auto max-w-2xl text-base leading-relaxed text-slate-500">
							{language === "fr"
								? "Nos mélanges ciblés associent des ingrédients appuyés par la recherche avec une formulation soignée pour soutenir votre vitalité."
					...
					<div className="grid gap-8 md:grid-cols-3">
						...
						>
							...
							/>
							<div className="absolute inset-0 bg-linear-to-t from-emerald-950/70 via-emerald-950/20 to-black/35 group-hover:from-emerald-950/80 group-hover:via-emerald-950/30 transition-colors duration-150" />
							...
							<div className="relative z-10">
								...
								<h3 className="mt-5 text-2xl sm:text-3xl font-playfair font-normal leading-tight text-white max-w-60">
									{language === "fr"
							...
							<div className="relative z-10 flex items-end justify-between mt-auto">
								...
								<div className="h-20 w-16 sm:h-24 sm:w-20 bg-white rounded-2xl flex items-center justify-center shadow-lg overflow-hidden transition-transform duration-150 group-hover:scale-125">
									<img
										src={heroProtein}
										alt="Protein canister"
				...
				<div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
					<div className="flex flex-col sm:flex-row sm:items-end justify-between gap-6 mb-8">
						<div className="flex-1">
							...
							<p className="mt-3 max-w-2xl text-sm leading-relaxed text-slate-500">
								{language === "fr"
									? "Sélectionnez une catégorie pour filtrer. Chaque mélange est créé pour vous aider à atteindre vos objectifs de performance et de récupération."
					...
					<div
						...
						className="flex overflow-x-auto gap-6 pb-6 scroll-smooth snap-x snap-mandatory scrollbar-none min-h-115"
					>
						<AnimatePresence mode="popLayout">
							{activeCategoryId && isPendingCategoryProducts ? (
								<motion.div
									key="category-loading"
									initial={{ opacity: 0 }}
									animate={{ opacity: 1 }}
									exit={{ opacity: 0 }}
									className="flex min-h-105 w-full items-center justify-center"
								>
							  ...
							  !Array.isArray(displayedCategoryProducts) ||
								...
								>
									<div className="max-w-md rounded-3xl border border-dashed border-emerald-900/15 bg-white px-8 py-10 text-center shadow-sm">
										...
										<p className="mt-2 text-sm leading-6 text-slate-500">
											{language === "fr"
												? "Les produits apparaîtront ici des que le backend les associera a cette catégorie."
				...
				<div className="grid gap-8 overflow-hidden rounded-[2rem] border border-emerald-900/10 bg-white p-5 shadow-xl shadow-emerald-950/5 lg:grid-cols-[0.9fr_1.1fr] lg:p-8">
					<div className="lg:sticky lg:top-28">
						<SectionHeading
							...
							title={
								language === "fr"
									? "Une vitrine plus guidée pour acheter plus vite."
									: "A more guided shelf for faster shopping."
							}
							copy={
								language === "fr"
						...
						<div className="mt-8 space-y-3">
							{[
								language === "fr"
									? "Vue rapide des routines"
									: "Quick routine scan",
								language === "fr"
									? "Cartes produit plus visuelles"
								...
								<div
									key={item}
									className="flex items-center gap-3 rounded-2xl border border-emerald-900/6 bg-emerald-50/50 px-4 py-3 text-sm font-semibold text-slate-700"
								>
						...
						{routineHighlights.map((item, index) => (
							...
							>
								<div className="relative aspect-4/3 overflow-hidden bg-white">
									...
									<span
										className={`absolute left-3 top-3 rounded-full border border-white/40 bg-white/90 px-2.5 py-1 text-[10px] font-black uppercase tracking-[0.18em] ${item.tone}`}
									>
									...
									<div className="flex items-center justify-between gap-3">
										<div>
											...
											<p className="mt-1 text-sm font-bold text-slate-900">
												{item.product?.name ||
													(language === "fr" ? "À découvrir" : "Discover now")}
											</p>
										</div>
										{item.product && (
				...
				<div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
					<div>
						<SectionHeading
							...
							title={
								language === "fr"
									? "L'achat de compléments bien-être devrait rendre les preuves faciles á voir."
									: "Wellness shopping should make the evidence easy to see."
							}
							copy={
								language === "fr"
									? "Au lieu de vagues promesses, Zamazor explique chaque formule par des notes d'ingrédients claires, des conseils de routine et des contrÃƒÂ´les de qualité."
									: "Instead of vague promises, Zamazor explains each formula through clean ingredient notes, routine guidance, quality checks, and proof points that help customers choose with confidence."
							}
						/>
						...
						<div className="grid sm:grid-cols-2">
							<div className="bg-[#eff8e8] p-5">
								...
								<h3 className="mt-3 text-2xl font-black text-slate-950">
									{language === "fr"
										? "Compléments aléatoires, résultats flous."
										: "Random supplements, unclear results."}
								</h3>
								<ul className="mt-5 space-y-3 text-sm text-slate-600">
									<li>
										{language === "fr"
											? "Plusieurs flacons avec des ingrédients redondants"
											: "Multiple bottles with overlapping ingredients"}
									</li>
									<li>
										{language === "fr"
											? "Pas d'ordre clair pour le matin ou les jours d'entraînement"
											: "No clear order for morning or training days"}
									</li>
									<li>
										{language === "fr"
											? "Difficile de savoir quoi recommander"
											: "Hard to know what to reorder"}
									</li>
								</ul>
							</div>
							<div className="bg-emerald-950 p-5 text-white">
								...
								<h3 className="mt-3 text-2xl font-black">
									{language === "fr"
										? "Un stack simple adapté à votre routine."
										: "A simple stack matched to your daily routine."}
								</h3>
								<ul className="mt-5 space-y-3 text-sm text-emerald-50/80">
									<li>
										{language === "fr"
											? "Objectifs clairs pour l'énergie, la force et la récupération"
											: "Clear goals for energy, strength, and recovery"}
									</li>
									<li>
										{language === "fr"
											? "ContrÃƒÂ´les d'abonnement faciles"
											: "Easy subscription controls"}
									</li>
									<li>
										{language === "fr"
											? "Preuve de formule affichée avant le paiement"
											: "Formula proof shown before checkout"}
									</li>
								</ul>
							</div>
						</div>
			...
			>
				<div className="grid gap-10 rounded-3xl border border-emerald-900/10 bg-white p-6 shadow-xl shadow-emerald-950/5 lg:grid-cols-[0.8fr_1.2fr] lg:p-10">
					<div>
						<SectionHeading
							kicker={
								language === "fr" ? "Comparez clairement" : "Compare clearly"
							}
							title={
								language === "fr"
									? "Des routines plus propres valent mieux que des placards encombrés."
									: "Cleaner routines beat crowded cabinets."
							}
							copy={
								language === "fr"
									? "Découvrez comment Zamazor simplifie votre stack de compléments par rapport aux boutiques de vitamines commerciales typiques."
									: "See how Zamazor simplifies your supplement stack compared to typical commercial vitamin stores."
							}
						/>
						<div className="mt-8 space-y-4">
							<div className="flex items-start gap-3">
								...
								<p className="text-sm text-slate-600 font-sans leading-relaxed">
									...
									{language === "fr"
										? " Pas de mélanges brevetés de remplissage. Vous connaissez exactement le dosage en milligrammes de chaque ingrédient."
										: " No filler proprietary blends. You know exactly how many milligrams of every ingredient you ingest."}
								</p>
							</div>
							<div className="flex items-start gap-3">
								<span className="grid size-5 shrink-0 place-items-center rounded-full bg-emerald-100 text-emerald-800 mt-1">
								...
								<p className="text-sm text-slate-600 font-sans leading-relaxed">
									<strong>
										{language === "fr"
											? "Zéro cochonnerie artificielle :"
											: "Zero artificial junk:"}
									</strong>
									{language === "fr"
										? " Sucré naturellement, coloré naturellement et facile à digérer."
										: " Naturally sweetened, naturally colored, and easy on your digestion."}
								</p>
							</div>
						</div>
					</div>
					...
					<div className="overflow-hidden rounded-2xl border border-emerald-900/10 shadow-sm">
						<div className="grid grid-cols-[1.2fr_1fr_1fr] bg-slate-950 text-xs sm:text-sm font-bold text-white items-center">
							...
							<div className="p-4 sm:p-5 text-center text-slate-400">
								{language === "fr" ? "Boutique typique" : "Typical store"}
							</div>
						</div>
						{comparisonData.map((row) => (
							...
							>
								...
								<div className="bg-emerald-50/50 p-4 sm:p-5 text-emerald-950 font-semibold border-x border-emerald-900/5 h-full flex flex-col justify-center items-center text-center gap-1.5">
									...
									<span className="text-[11px] sm:text-xs leading-tight text-emerald-800">
										{row.zamazor.text}
									</span>
								</div>
				...
				<div className="grid gap-12 lg:grid-cols-[0.8fr_1.2fr] lg:items-start">
					<div className="lg:sticky lg:top-28">
						<SectionHeading
							...
							title={
								language === "fr"
									? "Une meilleure routine est plus simple quand les étapes sont claires."
									: "A better routine is easier when the steps are obvious."
							}
							copy={
								language === "fr"
									? "Les stacks de Zamazor sont conçus autour des moments qui comptent le plus : l'énergie matinale, l'entraînement ciblé et la récupération nocturne."
									: "Zamazor stacks are designed around the moments that matter most: morning energy, focused training, and real recovery at night."
							}
						/>
						<div className="mt-8 rounded-2xl bg-emerald-50/50 border border-emerald-900/5 p-6">
							<h4 className="font-playfair text-lg font-bold text-emerald-950">
								{language === "fr"
									? "Pourquoi choisir les stacks"
									: "Why Stacking Works"}
							</h4>
							<p className="mt-2 text-xs sm:text-sm text-slate-600 leading-relaxed font-sans">
								{language === "fr"
									? "Prendre des vitamines au hasard réduit l'absorption et crée de la friction dans les habitudes. En regroupant les nutriments complémentaires le matin, à l'entraînement et le soir, vous gagnez en régularité et en efficacité."
							...
							{detailedStackSteps.map(
								(
									...
									>
										...
										<div className="absolute -left-9.5 sm:-left-11.75 top-6 z-10 flex size-8 sm:size-10 items-center justify-center rounded-full bg-white border border-emerald-900/10 shadow-xs group-hover:border-emerald-700 transition-colors">
											<span
												className={cn(
			...
			>
				<SectionHeading
					...
					title={
						language === "fr"
							? "Conçu pour ceux qui veulent un bien-être en toute simplicité."
							: "Designed for people who want wellness to feel simple."
					}
				/>
			...
			>
				<FAQSection
					title={
						language === "fr"
							? "Support des Compléments & Commandes"
							: "Supplement & Order Support"
					}
					subtitle={
						language === "fr"
					...
					description={
						language === "fr"
							? "Réponses rapides aux questions courantes sur nos ingrédients biologiques, la livraison, les abonnements et les normes de sécurité."
							: "Quick answers to common questions about our organic ingredients, shipping, subscriptions, and safety standards."
					}
					buttonLabel={
						language === "fr" ? "Aller au Centre d'Aide" : "Go to Help Center"
					}
					onButtonClick={() => {
					...
					faqsLeft={[
						{
							question:
								language === "fr"
									? "Les formules de compléments Zamazor sont-elles certifiées biologiques et sans OGM ?"
									: "Are Zamazor supplement formulas certified organic and non-GMO?",
							answer:
								language === "fr"
									? "Oui, tous nos mélanges sont formulés avec des extraits de plantes et minéraux 100% biologiques, sans OGM et propres. Nous n'utilisons jamais de colorants, d’arômes, d'édulcorants artificiels ou de liants chimiques synthétiques."
									: "Yes, all our supplement blends are crafted using 100% organic, non-GMO, clean botanical extracts and minerals. We never use artificial colors, flavors, sweeteners, or synthetic chemical binders.",
						},
						{
							question:
								language === "fr"
									? "Comment dois-je conserver mes boîtes de compléments Zamazor ?"
									: "How do I store Zamazor supplement canisters?",
							answer:
								language === "fr"
									? "Nous recommandons de conserver vos boîtes dans un endroit frais et sec, à l'abri de la lumière directe du soleil et de la chaleur. Veillez à bien refermer le couvercle après chaque utilisation pour éviter l'humidité."
									: "We recommend storing your canisters in a cool, dry pantry or cabinet, away from direct sunlight and heat. Always ensure the lid is sealed tightly after each serving to keep moisture out.",
						},
						{
							question:
								language === "fr"
									? "Puis-je combiner différentes formules Zamazor dans un même shake ?"
									: "Can I combine different Zamazor formulas in one shake?",
							answer:
								language === "fr"
									? "Absolument ! Nos produits sont conçus pour se compléter mutuellement. Mélanger notre protéine végétale avec notre mélange de superaliments dans votre smoothie du matin est un excellent choix riche en nutriments."
									: "Absolutely! Our products are designed to complement each other. Mixing our clean Protein powder with the organic Greens blend in your morning smoothie is a popular and nutrient-dense choice.",
						},
					]}
					faqsRight={[
						{
							...
							answer:
								language === "fr"
									? "Notre programme d'abonnement livre automatiquement vos formules préférées à votre porte tous les 30 jours. Vous bénéficiez d'une réduction de 10% sur chaque commande et pouvez suspendre, sauter ou annuler à tout moment."
									: "Our subscription plan delivers your favorite supplement formulas to your door every 30 days automatically. You receive a 10% discount on every order and can pause, skip, or cancel at any time.",
						},
						{
							question:
								language === "fr"
							...
							answer:
								language === "fr"
									? "Nous offrons la livraison standard gratuite sur toutes les commandes. Aucun achat minimum requis."
									: "We offer free standard shipping (3-5 business days) on all orders. No minimum purchase required.",
						},
						{
							question:
								language === "fr"
							...
							answer:
								language === "fr"
									? "Oui, nous sommes fiers de nos formules propres. Nous offrons une garantie de remboursement de 30 jours. Si vous n’êtes pas entièrement satisfait de votre stack, contactez-nous pour obtenir un remboursement rapide."
									: "Yes, we stand behind our clean formulas. We offer a 30-day money-back guarantee. If you are not completely satisfied with your supplement stack, contact us for a hassle-free refund.",
						},
					]}
				/>
			</motion.div>
