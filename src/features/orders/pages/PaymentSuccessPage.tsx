...
export default function PaymentSuccessPage() {
	...
	return (
		<div className="min-h-screen bg-[#fcfdfa] flex flex-col items-center justify-center p-4">
			<div className="max-w-md w-full bg-white rounded-3xl border border-brand-900/10 p-6 sm:p-8 text-center shadow-xl shadow-brand-950/5 animate-fade-in">
				<Breadcrumbs
					items={[
				...
				<div className="my-6 p-4 bg-brand-50/40 rounded-2xl border border-brand-900/5 text-left text-sm space-y-2.5">
					<div className="flex justify-between items-center">
						<span className="text-slate-500">{t("checkout.orderNumber")}:</span>
						<span className="font-mono font-semibold text-slate-900 bg-white px-2 py-0.5 rounded-md border border-brand-900/5 shadow-2xs">
					...
					<div className="flex justify-between items-center pt-1 border-t border-brand-950/5">
				...
				<div className="flex items-center justify-center gap-2 text-xs text-brand-800 font-semibold tracking-wider uppercase mb-6 bg-brand-50/60 py-2 rounded-lg">
				...
				<Button
					...
					className="w-full h-12 bg-brand-900 hover:bg-brand-950 text-white font-medium rounded-lg cursor-pointer shadow-md transition-all duration-200 active:scale-[0.98]"
				>
