...
export default function CheckoutPage() {
	const { t } = useLanguage();
	const { data: cartSummary, isPending, isFetching } = useCart();
	...
	return (
		<div className="min-h-screen bg-surface-3 text-ink selection:bg-brand-100 flex flex-col justify-between overflow-x-hidden">
			<div>
				<div className="bg-brand-950 px-4 py-2.5 text-center text-xs sm:text-sm font-semibold text-brand-50 flex items-center justify-center gap-2 relative z-50">
			...
			<footer className="text-center py-8 text-xs text-ink-faint border-t border-brand-900/5 mt-12 bg-card font-sans px-4">
				<p>
