		...
		return (
			<motion.button
				...
				className={cn(
					...
					isEmerald
						? `bg-emerald-950 text-emerald-50 border-0 outline-none ${showFill ? "shadow-[inset_0_0_0_1px_var(--color-lime-300),0_8px_20px_rgba(190,242,100,0.35)]" : "shadow-[inset_0_0_0_1px_#022c22,rgba(0,0,0,0.1)_0px_1px_3px_0px,rgba(0,0,0,0.06)_0px_1px_2px_0px]"}`
			...
			>
				<motion.span
					...
					className={cn(
						...
						isEmerald ? "bg-lime-300" : "bg-foreground dark:bg-neutral-50",
					)}
					initial={false}
					style={{
						height: coverSize,
